import { subscriptionTiers, TireNames } from "@/data/subscriptionTiers";
...
/* 
  One product can only have ONE customization
  One product can have MANY visitor view info
  One product can have MANY grouped discount
*/
...
/* 
  when the product is deleted, its related customization will be deleted as well.
...
/* 
  One customization belongs ONE product
  ProductCustomizationTable.productId => ProductTable.id
*/
...
/* 
  One product view can only belong to ONE product
  ProductViewTable.productId => ProductTable.id
  One product view can only report ONE country
  ProductViewTable.countryId => CountryTable.id
*/
...
/* 
  One country can only belong to ONE country group
  CountryTable.countryGroupId => CountryGroupTable.id
  One country can have MANY product view
*/
...
/* 
  One country group can have many countries
  one contry group can have product group discount
*/
...
/* 
  One country group discount can only belongs to one product
  One country group discount can only belongs to one country group
*/
...
export const TierEnum = pgEnum(
  "tier",
  Object.keys(subscriptionTiers) as [TireNames]
);
